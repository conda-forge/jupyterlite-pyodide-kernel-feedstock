...
Once the `conda-forge/label/jupyterlite_pyodide_kernel_rc` channel has been enabled, `jupyterlite-pyodide-kernel, jupyterlite-pyodide-kernel-with-lock` can be installed with `conda`:
